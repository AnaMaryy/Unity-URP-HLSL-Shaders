Shader "Thesis/HalftroneEffect"
{
    Properties
    {
        ...
        _ShadingMultiplier("Shading Multiplier", Float) = 0.1
        _CircleDensity("Circle Density", Float) = 5
        _CircleColor("Circle Color", Color) = (0,0,0, 1)
        _Softness("Softness", Range(0, 1)) = 0
        _Rotation("Rotation", Float) = 0
        _LitTreshold("Lit Treshold", Float) = 1
        _FalloffThreshold("Falloff Threshold", Float) = 2.5
        [Toggle(_USE_SCREEN_SPACE)]_USE_SCREEN_SPACE("Use Screen Space", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                /// todo check if really really correct
